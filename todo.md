...
## Fixes ##
- [ ] page rotation must include pdf.js text layer + save/reload
...
- [x] some light mode text is hard to read: Saved auto-complete text in the contect menu. the "Acknowlage & save button" in the help modal.
